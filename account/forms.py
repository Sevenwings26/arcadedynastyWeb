...
class UserRegistrationForm(UserCreationForm):
    email = forms.EmailField(label='', widget=forms.TextInput(attrs={'class':'block py-3', 'placeholder':'Unique email address'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs['class'] = 'py-3'
        ...
        self.fields['password2'].widget.attrs['class'] = 'py-3'
